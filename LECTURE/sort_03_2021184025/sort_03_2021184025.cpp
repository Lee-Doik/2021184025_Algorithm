...
bool city_Compare_y(const City &a, const City &b)
{
    return a.y < b.y;
}
...
City cities[] = {
    City("Write", 1336, 536), City("Prosy", 977, 860),  City("Rabbi", 6, 758),    City("Addle", 222, 261),
    ...
    City("Cress", 1253, 403), City("Zilch", 1289, 29),  City("React", 296, 659),  City("Fiche", 787, 278),
};
