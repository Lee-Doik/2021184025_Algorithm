...
let cities = [
  new City("Write", 1336, 536),  new City("Prosy", 977, 860),
  ...
  new City("Cress", 1253, 403),  new City("Zilch", 1289, 29),
...
// sort here by name
cities.sort((a, b)=>{return a.name.localeCompare(b.name)})
console.log(cities)

// sort here by x
cities.sort((a, b)=>{return a.x - b.x})
console.log(cities)
